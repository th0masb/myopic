...
new MyopicLambdaStack(app, "MyopicLambdaStack", {
  ...
  gameLambdaConfig: {
    ...
    timeout: cdk.Duration.minutes(
      Number.parseInt(process.env.GAME_HANDLER_FUNCTION_TIMEOUT_MINS!)
    ),
  ...
  benchLambdaConfig: {
    ...
    timeout: cdk.Duration.minutes(
      Number.parseInt(process.env.BENCHMARK_FUNCTION_TIMEOUT_MINS!)
    ),
  ...
  moveLambdaConfig: {
    ...
    timeout: cdk.Duration.minutes(
      Number.parseInt(process.env.MOVE_FUNCTION_TIMEOUT_MINS!)
    ),
