...
#[test]
fn mate_0() {
    test("r2r2k1/5ppp/1N2p3/1n6/3Q4/2B5/5PPP/1R3RK1 w Qq - 4 21", vec!["d4g7"], true)
}

#[test]
fn mate_1() {
    test("8/8/8/4Q3/8/6R1/2n1pkBK/8 w - - 0 1", vec!["g3d3"], true)
}

#[test]
fn mate_2() {
    test("8/7B/5Q2/6p1/6k1/8/5K2/8 w - - 0 1", vec!["f6h8", "f6f3"], true)
}

#[test]
fn mate_3() {
    test("3qr2k/1b1p2pp/7N/3Q2b1/4P3/8/5PP1/6K1 w - - 0 1", vec!["d5g8"], true)
}
...
#[test]
fn mate_4() {
    test("r1k2b1r/pp4pp/2p1n3/3NQ1B1/6q1/8/PPP2P1P/2KR4 w - - 4 20", vec!["e5c7"], true)
}

#[test]
fn mate_5() {
    test("r1b1k1nr/p2p1ppp/n2B4/1p1NPN1P/6P1/3P1Q2/P1P1K3/q5b1 w - - 0 30", vec!["f5g7"], true)
}
...
#[test]
fn tactic_1() {
    test("1r3k2/2R5/1p2p2p/1Q1pPp1q/1P1P2p1/2P1P1P1/6KP/8 b - - 2 31", vec!["b8a8"], false)
}
...
#[test]
fn tactic_2() {
    test("r5k1/pb4pp/1pn1pq2/5B2/2Pr4/B7/PP3RPP/R4QK1 b - - 0 23", vec!["e6f5"], false)
}
